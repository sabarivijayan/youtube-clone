  ...
  return (
    <div className="play-video">
      ...
      <div className="play-video-info">
        ...
        <div>
          <span><img src={assets.like} alt="" /> {apiData?value_converter(apiData.statistics.likeCount):"125"}</span>
          <span><img src={assets.dislike} alt="" /> {apiData?value_converter(apiData.statistics.dislikeCount):"2"}</span>
